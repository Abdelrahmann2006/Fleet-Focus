    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // ── Footer: Task Progress + Control Room Button ────────
    ...
    return Padding(
      ...
      child: Row(
        children: [
          // زر غرفة التحكم
          GestureDetector(
            onTap: () => context.push('/leader/device/${p.uid}'),
            child: Container(
              ...
              child: const Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(Icons.shield_outlined, size: 11, color: Colors.black),
                  SizedBox(width: 3),
                  Text('تحكم',
                      style: TextStyle(
                          fontSize: 10,
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: const Row(
                  ...
                  children: [
                    Icon(Icons.monitor_outlined, size: 13, color: AppColors.accent),
                    SizedBox(width: 5),
                    Text('غرفة التحكم',
                        style: TextStyle(
                            fontSize: 11,
